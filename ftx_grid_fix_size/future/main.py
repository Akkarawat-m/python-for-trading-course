...
while True:
    try:
        print('Starting future grid bot...')
        ...
        while asset_value < 0.01 and cash > 0:
            ...
            if free_col > min_trade_value and buy_size > min_size:
                ...
                print("Not Enough Collateral to buy {}".format(asset_name))
        ...
        while asset_value > 1 and free_col > 0:
            ...
            print('Grid Fix {} size is {}'.format(asset_name, fix_asset_control))
            ...
            if asset_size < fix_asset_control and price <= last_trade_price - step:
                ...
                print("Current {} Value more than grid fix value : trading -- Sell".format(asset_name))
